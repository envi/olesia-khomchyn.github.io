...
|-----:|:-------|
|**inventoryLocationExtendedId**: string *(uuid)* | Unique Identifier of the extended Inventory Location |
...
|**defaultExpenseLedgerNo**: string | Default Expense Ledger Account Code for the Inventory Item at a specific location |
...
|**inventoryLastUpdatedByName**: string | Name of the last user who updated the Inventory Item |
